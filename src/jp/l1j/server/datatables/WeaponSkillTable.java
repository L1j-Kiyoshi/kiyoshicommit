	...
	private void loadWeaponSkills(HashMap<Integer, L1WeaponSkill> weaponSkills) {
		...
		try {
			...
			while (rs.next()) {
				...
				int chaserCount = rs.getInt("chaser_count");
				int skillId = rs.getInt("skill_id");
				int arrowType = rs.getInt("arrow_type");
				boolean isHpDrain = rs.getBoolean("isHpDrain");
				...
				L1WeaponSkill weaponSkill = new L1WeaponSkill(weaponId,
						...
						chaserCount, skillId, arrowType, isHpDrain, enableMr);
