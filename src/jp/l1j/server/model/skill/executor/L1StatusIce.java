...
public class L1StatusIce extends L1BuffSkillExecutorImpl {

	@Override
	public void addEffect(L1Character user, L1Character target, int durationSeconds) {
		L1EffectSpawn.getInstance().spawnEffect(81168, durationSeconds, target.getX(), target.getY(), target.getMapId());
