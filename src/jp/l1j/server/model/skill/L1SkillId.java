...
public class L1SkillId {
	...
	public static final int EARTH_GUARDIAN = 151; // 旧 EARTH_SKIN
	...
	public static final int DANCING_BLAZE = 155; // E: 旧FIRE_BLESS
...
//	public static final int FIRE_BLESS = 155; // E: BLESS_OF_FIRE
	...
	public static final int REDUCE_WEIGHT = 218; // 旧JOY_OF_PAIN
	...
	public static final int UNIQUE_SKILL_OF_MONSTER_START = 4500;

	public static final int UNIQUE_SKILL_OF_MONSTER_END = 4999;

	public static final int DEATH_HEAL = 5000; // デスヒール

	public static final int DEATH_POTION = 5001; // デスポーション

	public static final int REDUCE_HEAL = 5002; // リデュースヒール

	public static final int MONSTER_CANCELLATION = 5003; // モンスター用のキャンセレーション(特殊計算用)

	public static final int CUBE_IGNITION_ALLY = 6500; // キューブ イグニション 味方

	public static final int CUBE_IGNITION_ENEMY = 6501; // キューブ イグニション 敵

	public static final int CUBE_QUAKE_ALLY = 6502; // キューブ イグニション 味方

	public static final int CUBE_QUAKE_ENEMY = 6503; // キューブ イグニション 敵

	public static final int CUBE_SHOCK_ALLY = 6504; // キューブ ショック 味方

	public static final int CUBE_SHOCK_ENEMY = 6505; // キューブ ショック 敵
	...
	public static final int STATUS_FLORA_POTION_AC = 1029;
	...
	public static final int EVIL_REVERSE = 1227; // イビルリバース

	public static final int EVIL_TRICK = 1228; // イビルトリック

	public static final int KNIGHTVALD_REDUCTION = 1492; // ナイトバルドのREDUCTION

	public static final int KNIGHTVALD_COUNTER_BARRIER = 1496; // ナイトバルドのカウンターバリア

	public static final int MUMMY_SKIN = 1508; // マミーロード鉄スキン
	...
	public static final int SPIRIT_OF_BLACK_SNAKE = 6000; // 黒蛇の気

	public static final int DIVINE_PROTECTION_OF_ANTHARAS = 9000; // アンタラスの加護

	public static final int DIVINE_PROTECTION_OF_FAFURION = 9001; // パプリオンの加護

	public static final int DIVINE_PROTECTION_OF_LINDVIOR = 9002; // リンドビオルの加護

	public static final int DIVINE_PROTECTION_OF_LINDVIOR_PLATE = 9003; // 魔力のリンドビオルの加護

	public static final int DIVINE_PROTECTION_OF_LINDVIOR_LEATHER = 9004; // 魔力のリンドビオルの加護

	public static final int DIVINE_PROTECTION_OF_LINDVIOR_SCALE = 9005; // 魔力のリンドビオルの加護

	public static final int DIVINE_PROTECTION_OF_LINDVIOR_ROBE = 9006; // 魔力のリンドビオルの加護

	public static final int DIVINE_PROTECTION_OF_VALAKAS = 9007; // ヴァラカスの加護

	public static final int DIVINE_PROTECTION_OF_HALLOWEEN = 9008; // ハロウィンの加護（ドラゴニックハロウィンアーマー）

	public static final int SHIELD_OF_TEAIROR = 9011; // 反逆者のシールド
