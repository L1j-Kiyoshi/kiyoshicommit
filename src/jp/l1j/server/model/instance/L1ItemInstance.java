...
public class L1ItemInstance extends L1Object {
	...
	public int getAc() {
		...
		if (getItemId() == 21353 && getEnchantLevel() >= 5) { // ルームティス ブルー イアリング
	...
	public int getHp() { //HP増加処理
		...
		if (_item.getType2() == 2 && _item.getType() >= 10
			...
			if (_inventoryItem.getEnchantLevel() > 0) {
				result += Math.min(getEnchantLevel() * 5 + 10, 50);
			}
		}

		if (_item.getItemId() == 21352) { // ルームティスレッドイアリング
			if (_inventoryItem.getEnchantLevel() > 0) {
				result += ((getEnchantLevel() + 1) * 10);
			}
		}
	...
	public int getHitModifier() {
		...
		if (getArmorSets() != null) {
			result += getArmorSets().getHitModifier();
		}
	...
	public int getDmgModifier() {
		...
		if (getArmorSets() != null) {
			result += getArmorSets().getDmgModifier();
		}
	...
	public int getBowHitModifier() {
		...
		if (getArmorSets() != null) {
			result += getArmorSets().getBowHitModifier();
		}
	...
	public int getBowDmgModifier() {
		...
		if (getArmorSets() != null) {
			result += getArmorSets().getBowDmgModifier();
		}
	...
	public int getWeightReduction() {
		...
		if (getArmorSets() != null) {
			result += getArmorSets().getWeightReduction();
		}
	...
	public int getDamageReduction() {
		...
		if (getArmorSets() != null) {
			result += getArmorSets().getDamageReduction();
		}
		...
		if (_item.getItemId() == 21352) { // ルームティスレッドイアリング
			if (_inventoryItem.getEnchantLevel() == 3) {
				result += 1;
			} else if (_inventoryItem.getEnchantLevel() > 3) {
				result += _inventoryItem.getEnchantLevel() - 3;
			}
		}
		return result;
	}
	...
	public int getDefenseEarth() {
		...
		if (getArmorSets() != null) {
			result += getArmorSets().getDefenseEarth();
		}
	...
	public int getDefenseWater() {
		...
		if (getArmorSets() != null) {
			result += getArmorSets().getDefenseWater();
		}
	...
	public int getDefenseFire() {
		...
		if (getArmorSets() != null) {
			result += getArmorSets().getDefenseFire();
		}
	...
	public int getDefenseWind() {
		...
		if (getArmorSets() != null) {
			result += getArmorSets().getDefenseWind();
		}
	...
	public int getDefenseLight() {
		int result = _item.getDefenseLight() + _inventoryItem.getDefenseLight();

		if (getArmorSets() != null) {
			result += getArmorSets().getDefenseLight();
		}
	...
	public int getResistStun() {
		...
		if (getArmorSets() != null) {
			result += getArmorSets().getResistStun();
		}
	...
	public int getResistStone() {
		...
		if (getArmorSets() != null) {
			result += getArmorSets().getResistStone();
		}
	...
	public int getResistSleep() {
		...
		if (getArmorSets() != null) {
			result += getArmorSets().getResistSleep();
		}
	...
	public int getResistFreeze() {
		...
		if (getArmorSets() != null) {
			result += getArmorSets().getResistFreeze();
		}
	...
	public int getResistHold() {
		...
		if (getArmorSets() != null) {
			result += getArmorSets().getResistHold();
		}
	...
	public int getResistBlind() {
		...
		if (getArmorSets() != null) {
			result += getArmorSets().getResistBlind();
		}
	...
	public int getExpBonus() {
		...
		if (getArmorSets() != null) {
			result += getArmorSets().getExpBonus();
		}
	...
	public boolean isHaste() {
		if (getArmorSets() != null) {
			return getArmorSets().getIsHaste() ||
					getItem().isHaste() || _inventoryItem.isHaste();
		}
	...
	public int getPotionRecoveryRate() {
		...
		if (getArmorSets() != null) {
			result += getArmorSets().getPotionRecoveryRate();
		}
	...
	public byte[] getStatusBytes() {
		...
		if (itemType2 == 0) { // etcitem
			...
			// MP吸収
			if (getItem().isMpDrain()) { // マナスタッフ、鋼鉄のマナスタッフ
				os.writeC(16);
			}
			// HP吸収
			if (getItem().isHpDrain()) { // ディストラクション
				os.writeC(34);
			}
			// STR~CHA
	...
	private L1ArmorSets _armorSets = null; // このアイテムが受けているセット効果

	public L1ArmorSets getArmorSets() {
		return _armorSets;
	}

	public void setArmorSets(L1ArmorSets as) {
		_armorSets = as;
	}
