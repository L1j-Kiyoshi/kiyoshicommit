...
public class L1ItemId {
	 ...
	 * 古代人の呪術スクロール(n-zel)
	 */
	public static final int MAGICSCROLL_OF_ANCIENTS = 40078;

	/**
	 * ギアンのスクロール
	 */
	public static final int SCROLL_OF_GIAN = 40129;

	/**
	 * ギアンのスクロール(B-ZEL)
	 */
	public static final int B_SCROLL_OF_GIAN = 140129;
	 ...
	 * 古代の武器強化スクロール
	 */
	public static final int A_SCROLL_OF_ENCHANT_WEAPON = 50670;

	/**
	 * 古代人の錬金術スクロール(n-dai)
	 */
	public static final int ALCHEMYSCROLL_OF_ANCIENTS = 40077;

	/**
	 * カルバスのスクロール
	 */
	public static final int SCROLL_OF_KARBAS = 40130;

	/**
	 * カルバスのスクロール(B-DAI)
	 */
	public static final int B_SCROLL_OF_KARBAS = 140130;
	 ...
	 * 装飾品強化スクロール
	 */
	public static final int SCROLL_OF_ENCHANT_ACCESSORY = 49148;
