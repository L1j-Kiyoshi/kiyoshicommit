...
public class S_CharVisualUpdate extends ServerBasePacket {
	...
	public S_CharVisualUpdate(L1PcInstance cha) {
		...
		writeD(_cha.getId());
		if (_cha.getWeapon() != null && _cha.getWeapon().getItem().getType() == 13) {
			if (_cha.getTempCharGfx() == 9206 || _cha.getTempCharGfx() == 9205
					|| _cha.getTempCharGfx() == 6157 || _cha.getTempCharGfx() == 6152
					|| _cha.getTempCharGfx() == 6147 || _cha.getTempCharGfx() == 6142
					|| _cha.getTempCharGfx() == 6137) {
				writeC(83);
			} else {
