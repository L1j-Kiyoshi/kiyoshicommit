...
public class Point {
	...
	private static final int HEADING_TABLE_X_LR[] = { 1, 1, 0, -1, -1, -1, 0, 1 };
	private static final int HEADING_TABLE_Y_LR[] = { 0, 1, 1, 1, 0, -1, -1, -1 };

	/**
	 * 指定された向きから右方向に座標をひとつ進める。
	 *
	 * @param heading
	 *            向き(0~7)
	 */
	public void rightward(int heading) {
		_x += HEADING_TABLE_X_LR[heading];
		_y += HEADING_TABLE_Y_LR[heading];
	}

	/**
	 * 指定された向きから左方向に座標をひとつ進める。
	 *
	 * @param heading
	 *            向き(0~7)
	 */
	public void leftward(int heading) {
		_x -= HEADING_TABLE_X_LR[heading];
		_y -= HEADING_TABLE_Y_LR[heading];
	}
