...
public class L1AddInstanceMap implements L1CommandExecutor {
	...
	public void execute(L1PcInstance pc, String cmdName, String arg) {
		try {
			...
			pc.sendPackets(new S_SystemMessage(String.format(I18N_GENERATED_THE_INSTANCE_MAP, buf, mapid)));
			// インスタンスマップ: %d を生成しました。(%d)
		} catch (Exception e) {
			pc.sendPackets(new S_SystemMessage(String.format(I18N_COMMAND_FORMAT_1, cmdName, I18N_MAP_ID)));
			// // .%s %s の形式で入力してください。
		}
	}
}
