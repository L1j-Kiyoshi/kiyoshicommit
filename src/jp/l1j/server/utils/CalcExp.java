...
public class CalcExp {
	 ...
	 * @return
	 */
	public static int calcPercentageExp(int level, int parcentage) {
		int needExp = ExpTable.getNeedExpNextLevel(level); // 次のレベルに必要な経験値
		return needExp * (parcentage / 100);
	}
