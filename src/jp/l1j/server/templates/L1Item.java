...
public abstract class L1Item implements Cloneable, Serializable {
	...
	private int[] _enchantScrolls = new int[] { -1 }; // ● 強化可能なスクロール

	public int[] getEnchantScrolls() {
		return _enchantScrolls;
	}

	public void setEnchantScrolls(int[] enchantScrolls) {
		_enchantScrolls = enchantScrolls;
	}

	private double _overEnchantRate = 1.0; // ● 武具固有のOE倍率。成功率が通常の何倍になるか。

	public double getOverEnchantRate() {
		return _overEnchantRate;
	}

	public void setOverEnchantRate(double overEnchantRate) {
		_overEnchantRate = overEnchantRate;
	}
