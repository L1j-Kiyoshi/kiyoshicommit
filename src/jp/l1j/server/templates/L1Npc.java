...
public class L1Npc extends L1Object implements Cloneable {
	...
	private int _resistEarth; // 地耐性

	public int getResistEarth() {
		return _resistEarth;
	}

	public void setResistEarth(int i) {
		_resistEarth = i;
	}

	private int _resistFire; // 火耐性

	public int getResistFire() {
		return _resistFire;
	}

	public void setResistFire(int i) {
		_resistFire = i;
	}

	private int _resistWater; // 水耐性

	public int getResistWater() {
		return _resistWater;
	}

	public void setResistWater(int i) {
		_resistWater = i;
	}

	private int _resistWind; // 風耐性

	public int getResistWind() {
		return _resistWind;
	}

	public void setResistWind(int i) {
		_resistWind = i;
	}

	private int _resistLight; // 光耐性

	public int getResistLight() {
		return _resistLight;
	}

	public void setResistLight(int i) {
		_resistLight = i;
	}
	...
	private int _poisonInterval;

	public int getPoisonInterval() {
		return _poisonInterval;
	}

	public void setPoisonInterval(int i) {
		_poisonInterval = i;
	}
