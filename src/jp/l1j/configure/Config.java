...
public final class Config {
	...
	private static final String RAID = "./config/raid.properties.xml";
	...
	@Configure(file = SERVER, key = "AutoRestart")
	...
	@Configure(file = RATE, key = "RateMaxWeightLimit")
	public static int RATE_MAX_WEIGHT_LIMIT = 5400;
	...
	@Configure(file = ALT, key = "UltimateBattle")
	public static boolean ULTIMATE_BATTLE = true;

	@Configure(file = ALT, key = "UltimateBattleNotice")
	public static int ULTIMATE_BATTLE_NOTICE = 11;
	...
	/** raid settings */
	@Configure(file = RAID, key = "Distortions")
	public static boolean DISTORTIONS = false;

	@Configure(file = RAID, key = "NextDistortionTime")
	public static int NEXT_DISTORTION_TIME = 2880;

	@Configure(file = RAID, key = "DistortionRaidOpenTime")
	public static int DISTORTION_RAID_OPEN_TIME = 150;

	@Configure(file = RAID, key = "DistortionRaidBossLimit")
	public static int DISTORTION_RAID_BOSS_LIMIT = 30;

	@Configure(file = RAID, key = "DistortionExtendTime")
	public static int DISTORTION_EXTEND_TIME = 1440;

	@Configure(file = RAID, key = "DragonKeyPrice")
	public static int DRAGON_KEY_PRICE = 10000000;

	@Configure(file = RAID, key = "DrugaBagPrice")
	public static int DRUGA_BAG_PRICE = 100000;

	@Configure(file = RAID, key = "DragonSlayserInterval")
	public static int DRAGON_SLAYER_INTERVAL = 4320;
