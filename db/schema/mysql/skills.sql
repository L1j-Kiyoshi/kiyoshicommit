...
CREATE TABLE `skills` (
  ...
  `base_skill_id` int(10) NOT NULL DEFAULT '-1',
  ...
  `remove_delay` int(10) unsigned NOT NULL DEFAULT '0',
  `reuse_delay` int(10) unsigned NOT NULL DEFAULT '0',
  `buff_duration` varchar(255) NOT NULL DEFAULT '0',
  ...
  `mr_value` int(10) unsigned NOT NULL DEFAULT '0',
  `mr_dice` double(10,1) unsigned NOT NULL DEFAULT '0.0',
  ...
  `cast_gfx_violet` int(10) NOT NULL DEFAULT '-1',
  ...
  `can_use_silence` tinyint(1) NOT NULL DEFAULT '0',
  `ignores_counter_magic` tinyint(1) NOT NULL DEFAULT '0',
  `ignores_absolute_barrier` tinyint(1) NOT NULL DEFAULT '0',
  `is_user_target` tinyint(1) NOT NULL DEFAULT '0',
