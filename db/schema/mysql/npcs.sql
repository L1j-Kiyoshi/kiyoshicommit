...
CREATE TABLE `npcs` (
  ...
  `resist_earth` int(10) NOT NULL DEFAULT '0',
  `resist_fire` int(10) NOT NULL DEFAULT '0',
  ...
  `atk_act_id` int(10) unsigned NOT NULL DEFAULT '0',
  ...
  `poison_interval` int(10) unsigned NOT NULL DEFAULT '0',
  ...
  `dead_timer` int(10) unsigned NOT NULL DEFAULT '0',
