...
set query=^
SELECT 'id','note','effect_item_id','sets','poly_id','ac','hp','mp','hpr','mpr','str','dex',^
...
'safe_enchant','enchant_scrolls','oe_rate','use_royal','use_knight','use_wizard','use_elf','use_darkelf',^
...
'original_wis','use_additional_warehouse','config','logout_time' ^
...
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
:: Dump distortion table
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
echo %outdir%/%datetime%/distortion.csv
set query=^
SELECT 'id','next_time','close_time','distortionX','distortionY','distortionMapId','teleportMapId' ^
UNION SELECT * INTO OUTFILE '%outdir%/%datetime%/distortion.csv' ^
FIELDS TERMINATED BY '%delimiter%' ENCLOSED BY '%enclosed%' ^
LINES TERMINATED BY '%newline%' ^
FROM %database%.distortion
mysql -u %username% -p%password% -e "%query%" --local-infile=1
if errorlevel 1 goto ERR
...
:: Dump events table
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
echo %outdir%/%datetime%/events.csv
set query=^
SELECT 'event_id','name','start_time','end_time','next_start' ^
UNION SELECT * INTO OUTFILE '%outdir%/%datetime%/events.csv' ^
FIELDS TERMINATED BY '%delimiter%' ENCLOSED BY '%enclosed%' ^
LINES TERMINATED BY '%newline%' ^
...
'area_id','max_time','is_account','reset_date','reset_week','reset_time' ^
...
set query=^
SELECT 'account_id','char_id','area_id','remaining_time' ^
...
set query=^
SELECT 'npc_id','note','normal_action','chaotic_action','teleport_url','teleport_urla','currency_item_id' ^
...
'digest_item','brave_speed','dead_timer','hpr_interval','hpr','mpr_interval','mpr',^
...
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
:: Dump physical_skills table
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
echo %outdir%/%datetime%/physical_skills.csv
set query=^
SELECT 'skill_id','name','type','ranged','action_id','damage_value','damage_dice','damage_dice_count',^
'area','base_left_right','base_front_back','area_front','area_back','area_right','area_left' ,^
'castgfx','area_effect' ^
UNION SELECT * INTO OUTFILE '%outdir%/%datetime%/physical_skills.csv' ^
FIELDS TERMINATED BY '%delimiter%' ENCLOSED BY '%enclosed%' ^
LINES TERMINATED BY '%newline%' ^
FROM %database%.physical_skills
mysql -u %username% -p%password% -e "%query%" --local-infile=1
if errorlevel 1 goto ERR
...
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
:: Dump raid_config table
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
echo %outdir%/%datetime%/raid_config.csv
set query=^
SELECT 'raid_id','raid_name','min_level','max_level','min_player','max_player','max_raid_limit' ^
UNION SELECT * INTO OUTFILE '%outdir%/%datetime%/raid_config.csv' ^
FIELDS TERMINATED BY '%delimiter%' ENCLOSED BY '%enclosed%' ^
LINES TERMINATED BY '%newline%' ^
FROM %database%.raid_config
mysql -u %username% -p%password% -e "%query%" --local-infile=1
if errorlevel 1 goto ERR

::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
:: Dump raid_drop table
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
echo %outdir%/%datetime%/raid_drop.csv
set query=^
SELECT 'raid_id','pattern_id','set_id','item_id','item_name','min_count','max_count','chance' ^
UNION SELECT * INTO OUTFILE '%outdir%/%datetime%/raid_drop.csv' ^
FIELDS TERMINATED BY '%delimiter%' ENCLOSED BY '%enclosed%' ^
LINES TERMINATED BY '%newline%' ^
FROM %database%.raid_drop
mysql -u %username% -p%password% -e "%query%" --local-infile=1
if errorlevel 1 goto ERR
...
set query=^
SELECT 'npc_id','item_id','note','order_id','pack_count','is_laytax' ^
...
set query=^
SELECT 'id','name','base_skill_id','skill_level','skill_number','consume_mp','consume_hp',^
'consume_item_id','consume_amount','remove_delay','reuse_delay','buff_duration','target',^
'target_to','damage_value','damage_dice','damage_dice_count',^
'probability_value','probability_dice','mr_value','mr_dice','probability_max','attr','type',^
'lawful','ranged','area','through','skill_id','name_id','action_id','cast_gfx','cast_gfx_violet',^
'cast_gfx2','sys_msg_id_happen','sys_msg_id_stop','sys_msg_id_fail',^
'can_cast_with_invis','can_use_silence','ignores_counter_magic',^
'ignores_absolute_barrier','is_user_target','is_buff','impl' ^
...
set query=^
SELECT 'id','npc_id','note','event_id','group_id','cycle_type','count','loc_x','loc_y',^
'random_x','random_y','loc_x1','loc_y1','loc_x2','loc_y2','heading','map_id','random_map_id', ^
...
set query=^
SELECT 'id','npc_id','note','event_id','group_id','count','loc_x','loc_y','random_x',^
...
set query=^
SELECT 'id','npc_id','note','event_id','count','loc_x','loc_y','random_x','random_y',^
...
set query=^
SELECT 'id','ub_id','pattern','group_id','npc_id','note','count','spawn_delay','is_drop','seal_count' ^
...
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
:: Dump ub_config table
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
echo %outdir%/%datetime%/ub_config.csv
set query=^
SELECT 'id','name','manager_id','manager_x','manager_y','manager_map_id','manager_heading',^
'sub_manager_id','sub_manager_x','sub_manager_y','sub_manager_map_id','sub_manager_heading',^
'map_id','area_x1','area_y1','are_x2','area_y2',^
...
UNION SELECT * INTO OUTFILE '%outdir%/%datetime%/ub_config.csv' ^
FIELDS TERMINATED BY '%delimiter%' ENCLOSED BY '%enclosed%' ^
LINES TERMINATED BY '%newline%' ^
FROM %database%.ub_config
mysql -u %username% -p%password% -e "%query%" --local-infile=1
if errorlevel 1 goto ERR
...
'random_damage','chaser_count','skill_id','arrow_type','isHpDrain','enable_mr' ^
...
'dmg_small','dmg_large','range','safe_enchant','enchant_scrolls','oe_rate','use_royal','use_knight',^
'use_wizard','use_elf','use_darkelf','use_dragonknight','use_illusionist',^
'hit_modifier','dmg_modifier','sayha_dmg','sayha_gfx','pvp_hit_modifier','pvp_dmg_modifier',^
'str','con','dex','int','wis','cha','hp','mp',^
'hpr','mpr','sp','mr','is_haste','is_hpDrain','hp_drain_chance','is_mpDrain','weapon_special',^
